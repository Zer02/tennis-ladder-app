...
<template>
  <div>
    ...
    <div>
      ...
      <p>Win Percentage: {{ calculateWinPercentage(player.wins, player.losses) }}%</p>
    </div>
  </div>
</template>
...
export default {
  ...
  created() {
    // Fetch player data based on the route parameter (player id)
...
/* Add any additional styling for the player profile page */
</style>
